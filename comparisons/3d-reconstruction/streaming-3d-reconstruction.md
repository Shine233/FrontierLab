...
- [`reports/feedforward_3d_reconstruction_compare.md`](../../reports/feedforward_3d_reconstruction_compare.md) 更关注 **多视图 / 多先验 / metric 3D reconstruction**，候选包括 MapAnything、OmniVGGT、HunyuanWorld-Mirror。
