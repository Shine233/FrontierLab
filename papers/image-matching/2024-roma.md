...
- 取代/改进：[DKM](../image-matching/2023-dkm.md)（同作者前作，同稠密 warp 回归框架；RoMa 换 DINOv2 coarse + anchor decoder + RbC/鲁棒损失全面超越）
- 基于：[DINOv2](../3d-reconstruction/2023-dinov2.md)（冻结自监督 ViT-L/14 提供 coarse 鲁棒特征）
