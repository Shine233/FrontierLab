...
| Any-view Visual Geometry Foundation Models | 3d-reconstruction / dense-vision / robotics-autonomous-driving | Depth Anything 3 / VGGT / Pi3 / MapAnything / LingBot-Map / Depth Anything 2 | initial-completed | [`comparisons/3d-reconstruction/visual-geometry-foundation-models.md`](../comparisons/3d-reconstruction/visual-geometry-foundation-models.md) | DA3 是当前 any-view visual geometry 主候选；MapAnything 更适合 metric prompts；LingBot-Map 更适合 causal streaming；DA2 仍适合作为单目 depth baseline。 |
