...
| Any-view Visual Geometry Foundation Models | 3d-reconstruction / dense-vision / robotics-autonomous-driving | Depth Anything 3 / VGGT / Pi3 / MapAnything / LingBot-Map / Depth Anything 2 | initial-completed | [`comparisons/3d-reconstruction/visual-geometry-foundation-models.md`](../comparisons/3d-reconstruction/visual-geometry-foundation-models.md) | DA3 是当前 any-view visual geometry 主候选；Pi3 是 reference-free / input-order-robust baseline；MapAnything 更适合 metric prompts；LingBot-Map 更适合 causal streaming。 |
| 前馈式三维重建方法对比 | 3d-reconstruction / robotics-autonomous-driving | MapAnything / Pi3 / HunyuanWorld-Mirror / OmniVGGT | completed | [`reports/feedforward_3d_reconstruction_compare.md`](../reports/feedforward_3d_reconstruction_compare.md) | MapAnything 更适合作为自动驾驶/机器人 metric 3D 重建主候选；Pi3/Pi3X 是 reference-free 与输入顺序鲁棒性 baseline；HunyuanWorld-Mirror 适合多先验与 3DGS/NVS 分支。 |
